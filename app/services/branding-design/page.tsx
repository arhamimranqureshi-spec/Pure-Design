...
.group:hover .animate-scroll-right {
            ...
            <div className="space-y-8">
             ...
             Elevate Your Brand <br />
              ...
              <p className="hero-line-3 text-gray-300 text-xl md:text-2xl mb-12 max-w-xl leading-relaxed font-light">
                At PureDesignHub, we specialize in creating impactful and memorable digital brand identities that resonate with your target audience. With our Digital Branding Services, we help businesses in the USA craft a compelling online presence that drives engagement, builds trust, and boosts conversions. Whether you’re a startup or an established business, we tailor our strategies to align with your vision and business goals. <span className="text-white font-semibold">  </span> 
              </p>
  ...
  <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
    ...
    <div className="reveal-left">
      ...
      <ul className="space-y-4 text-gray-600">
        <li>
          <strong>Enhanced Visibility:</strong> A strong digital brand helps you stand out in the competitive digital landscape.
        </li>
        <li>
          <strong>Trust and Credibility:</strong> Effective branding builds trust and positions your business as a reputable entity in your industry.
        </li>
        <li>
          <strong>Consistency Across Channels:</strong> A unified digital branding strategy ensures consistent messaging across all platforms.
        </li>
        <li>
          <strong>Customer Loyalty:</strong> When customers connect with your brand, they’re more likely to become loyal advocates.
        </li>
      </ul>
    </div>
  ...
  <div className="max-w-[1400px] mx-auto grid md:grid-cols-3 gap-6 stagger-child">
    {webServices.map((s, i) => (
      <div
        key={i}
